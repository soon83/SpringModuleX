...
PRIVILEGES
ON
`spring_module_x_generate`
.
*
TO
'spring_module_x_generate'@'%' IDENTIFIED BY 'spring_module_x_generate!@34';
...
PRIVILEGES
ON
`spring_module_x_local`
.
*
TO
'spring_module_x_local'@'%' IDENTIFIED BY 'spring_module_x_local!@34';
